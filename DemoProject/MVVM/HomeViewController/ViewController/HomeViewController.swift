...
//        var protocolUserData : UserDataRepresentable
//        protocolUserData = self.results[indexPath]
//        let viewModal = TableViewCellViewModel()
//
//        cell.viewModel?.address = modal.location.street.name
//        cell.
//        cell.prepare(with: modal)
